...
| `-noerr, --no-validation-errors`              | When set, errors while validating packages are ignored. The output will only contain successfully validated packages.                                                                                                                                                                                                                                                                                                                                      |
| `-url, --include-project-urls`                | When set, projects urls will be included in the output.                                                                                                                                                                                                                                                                                                                                                                                                    |
